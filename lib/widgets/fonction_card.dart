...
class fonction_card extends StatelessWidget {
  const fonction_card({
    ...
    required this.cas_utili, required this.press
  });
  ...
  Widget build(BuildContext context) {
    return Container(
                ...
                child: InkWell(
                  ...
                  child: Stack(
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          height: 160,
                          width: 200,
                          child: Image.asset(cas_utili.image,
                          fit: BoxFit.cover,
                          ),
                        )
                        ),
                  ...
                  child: Text(cas_utili.title,style: TextStyle(fontFamily: AutofillHints.countryName,fontSize: 20),),
                                ),
                                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 10),
                  child: Text(cas_utili.subTitle,style: TextStyle(fontSize: 15),),
                                ),
                              ],
                            ),
                        ))
