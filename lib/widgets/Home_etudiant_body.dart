 ...
 // child:Image.asset("images/anonce.png",fit: BoxFit.cover,)
          ...
          Align(
            ...
            child: Container(
              ...
              width: 60,
              decoration: BoxDecoration(
                color: Color.fromARGB(255, 204, 137, 12),
                shape: BoxShape
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => AjouterReclamation()));
                },
                child: Icon(Icons.add),
                style: ElevatedButton.styleFrom(
                  shape:
                      CircleBorder(), // Pour rendre le bouton circulaire à l'intérieur du conteneur circulaire
                  padding: EdgeInsets.all( 0), // Aucun espace de remplissage à l'intérieur du bouton
                ),
              ),
            ),
          )
